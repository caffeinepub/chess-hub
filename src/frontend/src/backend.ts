...
export class Backend implements backendInterface {
    ...
    async cancelGame(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cancelGame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createGame(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getActiveGames(): Promise<Array<GameSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveGames();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerPlayerStats(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerPlayerStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFinishedGames(): Promise<Array<GameSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFinishedGames();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerGameHistory(arg0: Principal): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerGameHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserSubscriptions(arg0: Subscription): Promise<Array<[Principal, Time]>> {
        if (this.processError) {
            try {
    ...
    async grantSubscription(arg0: Principal, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.grantSubscription(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async joinGame(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async makeMove(arg0: bigint, arg1: bigint, arg2: bigint, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.makeMove(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerPlayer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async resignGame(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resignGame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async revokeSubscription(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
